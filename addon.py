...
__scriptID__ = 'plugin.video.mrknow.wizjatv'
__addon__ = xbmcaddon.Addon(id='plugin.video.mrknow.wizjatv')
...
control.log('MODE %s' % mode)

if mode is None:
    wizja.wizja_check_staus()
    ...
    control.clear_session_file()
    control.log('WYCZYSCILEM CACHE')
